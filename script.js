...
document.getElementById("quizForm").addEventListener("submit", function(e) {
  ...
  // lógica de recomendaciones con links cliqueables
  if (experiencia === "Sin experiencia" && discapacidad === "Sí") {
    recomendacion = `
      Te recomendamos:
      <br><br>
      ♿ <strong><a href="https://www.incluyeme.com.ar/" target="_blank">Incluyeme</a></strong>
      <br>
      🎓 <strong><a href="https://www.santanderopenacademy.com/" target="_blank">Becas Santander Open Academy</a></strong>
      <br>
      💼 <strong><a href="https://www.argentina.gob.ar/trabajo/portalempleo" target="_blank">Portal Empleo Argentina</a></strong>
    `;
  } else if (experiencia === "Sin experiencia") {
    recomendacion = `
      Te recomendamos:
      <br><br>
      💼 <strong><a href="https://www.linkedin.com/" target="_blank">Trabajos trainee en LinkedIn</a></strong>
      <br>
      🎓 <strong><a href="https://www.argentina.gob.ar/educacion/progresar" target="_blank">Becas Progresar</a></strong>
      <br>
      📚 <strong><a href="https://www.santanderopenacademy.com/" target="_blank">Cursos gratuitos Santander</a></strong>
      <br>
      🌎 <strong><a href="https://www.argentina.gob.ar/trabajo/portalempleo" target="_blank">Portal Empleo</a></strong>
    `;
  } else {
    recomendacion = `
      Te recomendamos:
      <br><br>
      💼 <strong><a href="https://www.linkedin.com/jobs/" target="_blank">LinkedIn Jobs</a></strong>
      <br>
      📈 <strong><a href="https://www.coursera.org/" target="_blank">Cursos de especialización</a></strong>
      <br>
      🎓 <strong><a href="https://www.santanderopenacademy.com/" target="_blank">Santander Open Academy</a></strong>
    `;
  }
